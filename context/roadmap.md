...
- [ ] **[theme]** **Give the app a fresh, modern dark look — Discord-style dark background with green as the main accent color.** — Dark mode redesign: keep it dark but more modern, in the spirit of Discord's dark background, with green as the primary color. (דארק מוד מודרני בסטייל דיסקורד, ירוק primary)
